    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addNewRecordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myDBHelper.createNewBookRecord(enterBookTitle.getText().toString().trim(), enterBookAuthor.getText().toString().trim(), Integer.valueOf(enterBookPages.getText().toString().trim()));
            }
        });
